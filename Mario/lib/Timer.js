...
export default class Timer {
	 ...
	 */
	addTask(action, interval, duration = 0, callback = () => { }, id = 0) {
		const task = new Task(action, interval, duration, callback, id);
...
class Task {
	 ...
	 * @param {function} callback The function to execute after duration has passed.
	 */
	constructor(action, interval, duration = 0, callback = () => { }, id = 0) {
		this.action = action;
